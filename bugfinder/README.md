...
2. **Hypothesis diversity comes from lenses × seeds, not just "different
   ...
   failure-mode class from `lenses.md`, grounded in the empirical literature
   on silent bugs in ML code) and one *seed* (an entry point, a
...
| `prompts/lenses.md` | Lens definitions consumed by 03 | — |
